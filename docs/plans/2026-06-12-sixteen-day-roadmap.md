...
- **F-RLS-04c** — Routes-context RLS (separate pass — flips the 5 Routes routes onto `routesServiceForCaller` + adds Routes write policies; mirror of F-RLS-04a/04b). After F-24. **← NEXT UNIT.**
