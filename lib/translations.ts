...
const t = {
  ...
  tabAllVisits:        { en: 'All',                     tr: 'Tümü'                          },
  tabRoutine:          { en: 'Routine',                 tr: 'Rutin'                         },
  tabProspects:        { en: 'Prospects',               tr: 'Adaylar'                       },
  tabStalled:          { en: 'Stalled',                  tr: 'Durdu'                         },
  notProgressingHint:  { en: 'Still in play — gone quiet or needs time', tr: 'Hâlâ devam ediyor — sessiz veya zamana ihtiyacı var' },
  notWonHint:          { en: 'Lost — said no or went elsewhere',         tr: 'Kaybedildi — hayır dedi veya başkasını tercih etti' },
  visitNotes:          { en: 'Notes',                   tr: 'Notlar'                        },
  noNotes:             { en: 'No updates yet',          tr: 'Henüz güncelleme yok'          },
  addNotePlaceholder:  { en: 'Add an update…',          tr: 'Güncelleme ekle…'              },
  postNote:            { en: 'Post',                    tr: 'Gönder'                        },
  editNote:            { en: 'Edit',                    tr: 'Düzenle'                       },
  saveNote:            { en: 'Save',                    tr: 'Kaydet'                        },
  originalNote:        { en: 'Original note',           tr: 'Orijinal not'                  },
