...
const CATEGORIES: { label: string; freq: string }[] = [
  ...
  { label: 'Burger machine',                  freq: 'After each run + end of shift' },
  { label: 'Mixer',                           freq: 'After each use + end of shift' },
  { label: 'Band saw',                        freq: 'After each use + end of shift' },
              ...
              <div className="bg-white rounded-xl p-4">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    ['Burger machine',               'After each run + end of shift'],
                    ['Mixer',                        'After each use + end of shift'],
                    ['Band saw',                     'After each use + end of shift'],
