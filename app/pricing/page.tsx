...
/** Map the page's snake_case Agreement to the owned PriceAgreementPdfData slip
 *  and delegate to the wired PdfRenderer. The heavy jsPDF routine lives behind
 *  the lib/adapters/jspdf/ adapter (F-22) — the page never sees the vendor. The
 *  call sites (onExportPdf) keep the same (agreement: Agreement) => … signature. */
