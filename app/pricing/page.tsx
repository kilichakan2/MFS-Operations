...
async function exportPdf(agreement: Agreement) {
  ...
  // MFS logo — SVG embedded as base64, sized to fit the header
  // Logo aspect ratio: 912×238 ≈ 3.83:1 → at 52mm wide = ~13.6mm tall
  ...
  doc.addImage(logoDataUri, 'SVG', 12, 7.2, 52, 13.6)
