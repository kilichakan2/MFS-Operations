...
// ── Sunmi label helpers ────────────────────────────────────────────────────────
// These exercise the pure helpers extracted from lib/printing/sunmi.ts so
// label-content logic survives the Capacitor → JavaScript bridge migration.

import { formatBornLine, formatTempStatus, formatSpecies, isSunmiNative } from '@/lib/printing/sunmi'
